    ...
    <div className="pt-16 pb-16" id="features">
      ...
      <div className="w-[80%] mx-auto mt-16 grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <div
          ...
          data-aos-delay="0"
        >
          <FeatureCard icon="zap" title="Lightning Fast Delivery" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="100"
        >
          <FeatureCard icon="utensils" title="Wide Menu Selection" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="200"
        >
          <FeatureCard icon="shield-check" title="Safe & Secure Orders" />
        </div>
      </div>
    </div>
  );
